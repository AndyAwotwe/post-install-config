...
This tutorial outlines the post-install configuration of the open-source help desk ticketing system osTicket. This tutorial assumes you have fully completed, installed, set up login credentials, and perform clean up on osTicket in your Virtual Machine environment via following the previous tutorial <a href ="https://github.com/AndyAwotwe/osticket-prereqs">"osTicket - Prerequisites and Installation"</a><br />
...
<h3 align = "right">Next Tutorial - <a href = "https://github.com/AndyAwotwe/ticket-lifecycle">osTicket: Ticket Lifecycle Examples</a></h3>
